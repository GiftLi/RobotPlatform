#include "HR_ElectricBoxHansV2.h"


HR_ElectricBoxHansV2::HR_ElectricBoxHansV2(bool bErrorRecovryLINK,int nSlave,const char *device, int baud, char parity,int data_bit, int stop_bit):
...
HR_ElectricBoxHansV2::~HR_ElectricBoxHansV2()
{

}
int HR_ElectricBoxHansV2::Sync()
{
    /* 申请内存空间 */
...
int HR_ElectricBoxHansV2::HandleSTData(const uint16_t* pBuf)
{
...
bool HR_ElectricBoxHansV2::TestConnect()
{
    uint16_t dest=0;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
int HR_ElectricBoxHansV2::Electrify48VOUT()
{
...
int HR_ElectricBoxHansV2::Blackout48VOUT()
{
	__useconds_t ms_10 = 10 * 1000;
...
int HR_ElectricBoxHansV2::ResetEmergencyStop()
{
	__useconds_t ms_10 = 10 * 1000;
...
int HR_ElectricBoxHansV2::ResetSafetyGuradStop()
{
    return 0;
}

int HR_ElectricBoxHansV2::SetAnalogOUT_Mode(int nIndex,int nAnalogMode)
{
...
int HR_ElectricBoxHansV2::SetAnalogOUT_Value(int nIndex,double dbAnalogOUT)
{
    int nRegisterAddr = 0;
...
int HR_ElectricBoxHansV2::SetDO(int nIndex,int nVal)
{
    /* 获取当前的IO状�?? */
	uint16_t pTmpBuf = 0;
...
int HR_ElectricBoxHansV2::SetSO(int nIndex,int nVal)
{
    uint16_t pTmpBuf = 0;
