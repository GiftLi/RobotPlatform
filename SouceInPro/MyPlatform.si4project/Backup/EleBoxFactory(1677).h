...
#define INIT_ELEBOX_TCP_INSTANCE(EleBox_Type,nDeviceID,strIp,nPort) (EleBoxFactory::getEleBoxFactoryInstance()->getEleBoxInstance(EleBox_Type,nDeviceID,strIp,nPort))

#define INIT_ELEBOX_RTU_INSTANCE(EleBox_Type,strSerialPath)  (EleBoxFactory::getEleBoxFactoryInstance()->getEleBoxInstance(EleBox_Type,strSerialPath))

#define GET_ELEBOX_INSTANCE() (EleBoxFactory::getEleBoxFactoryInstance()->getEleBoxInstance())
