...
public:
    ...
    virtual int electrify48vOut(void)=0;
...
{
public:
    ElectricityBoxHAL* getEleBoxInstance(EN_BoxVersion enVersion,string strIp,int nPort);
    ElectricityBoxHAL* getEleBoxInstance(EN_BoxVersion enVersion,string strPath);

private:
    ElectricityBoxHAL* m_pEleBox;
};
