...
class EleBoxV2:public ElectricityBoxHAL
{
public:
    EleBoxV2(int nSlaveId, string strIp,int nPort):
            ElectricityBoxHAL(nSlaveId,strIp,nPort){};
	
    EleBoxV2(string strPath):ElectricityBoxHAL(strPath){};

    virtual ~EleBoxV2(){};

	int electrify48vOut(void);
	int blackout48vOut(void);
